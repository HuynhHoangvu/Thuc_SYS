...
import { createActivityService, updateActivityService, deleteActivityService, } from "../services/activity.service.js";
...
export const updateActivity = asyncHandler(async (req, res) => {
    try {
        ...
        const updatedActivity = await updateActivityService(id, completed);
        getIO().emit("data_changed");
