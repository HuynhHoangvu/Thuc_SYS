            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6">
              ...
              {student && (
                <>
                  ...
                  {activeTab === 'workflow' && (
                    <WorkflowTab studentId={student._id} destinationCountry={student.studyAbroad?.destinationCountry} />
                  )}
                  {activeTab === 'checklist' && (
                    <ChecklistTab studentId={student._id} destinationCountry={student.studyAbroad?.destinationCountry} />
                  )}
                  {activeTab === 'documents' && <DocumentsTab studentId={student._id} />}
                  {activeTab === 'forms' && <FormsTab studentId={student._id} />}
                </>
              )}
            </div>
          </div>
