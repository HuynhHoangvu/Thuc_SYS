...
import runCycleAnimation from "../assets/Run cycle recreated in Lottie Creator.json";
...
const CrmPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed bottom-0 left-0 z-40 h-16 w-16 md:h-24 md:w-24 run-cycle-marquee" aria-hidden="true">
        <Lottie animationData={runCycleAnimation} loop autoplay />
      </div>
    </>
  );
};
